function userOptions = defineUserOptions_tutorial()
%
...
userOptions.analysisName = 'tutorial_Feb19';

% This is the root directory of the project.
userOptions.rootPath = '/Volumes/TOSHIBA/rsatoolbox-develop/tutorial';
...
[userOptions.conditionLabels{1:20}] = deal(' ');
...
userOptions.conditionColours = [repmat([1 0 0], 10,1); repmat([0 0 1], 10,1)];
